...
namespace SettingsEditor
{
    ...
    public class FloatSetting : Setting
    {
            ...
            : base(field, SettingType.Float, group)
        {
            ...
            HasCheckBox = CheckBoxAttribute.GetCheckBox( field, ref ValueBool );
            if ( HasCheckBox )
		...
		public override void WriteDeclaration( List<string> lines )
		{
			...
			if ( val.Contains( "." ) )
				val = val + 'f';
            if ( HasCheckBox )
                lines.Add( "\tSettingsEditor::FloatBool " + Name + " = SettingsEditor::FloatBool( " + val + ", " + ValueBool + " );" );
            else
        ...
        public override void WriteDeclaration( FileWriter fw )
        {
            ...
            if ( val.Contains( "." ) )
                val = val + 'f';
            if ( HasCheckBox )
                fw.AddLine( "SettingsEditor::FloatBool " + Name + " = SettingsEditor::FloatBool( " + val + ", " + ValueBool.ToString().ToLower() + " );" );
            else
