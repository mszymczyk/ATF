...
namespace picoAnimClipEditor
{
	...
	//[Export(typeof(IpicoAnimListEditor))]
    [Export(typeof(IInitializable))]
    [Export(typeof(picoAnimListEditor))]
    [PartCreationPolicy(CreationPolicy.Any)]
    public class picoAnimListEditor : TreeControlEditor, IControlHostClient, IInitializable
    {
        /// <summary>
        /// Constructor</summary>
            ...
            : base(commandService)
        {
            ...
            m_control.Name = "AnimList".Localize();
            m_control.Text = "AnimList".Localize();
        ...
        #region IpicoAnimListEditor Members
        ...
        {
            public PaletteTreeAdapter(picoAnimListEditor picoAnimListEditor, StringSearchInputUI searchInput,
                IComparer<string> categoryComparer)
            {
                m_picoAnimListEditor = picoAnimListEditor;
            ...
            private readonly picoAnimListEditor m_picoAnimListEditor;
            ...
            public void GetInfo(object item, ItemInfo info)
            {
                ...
                if (item != this)
                {
                    ...
                    {
                        IPaletteClient client = m_picoAnimListEditor.m_objectClients[item];
