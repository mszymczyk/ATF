...
namespace picoTimelineEditor.DomNodeAdapters
{
	...
	public class IntervalNodeAnimation : Interval, ICurveSet, ITimelineObjectCreator
    {
		...
		{
			DomNode dn = new DomNode( Schema.intervalNodeAnimationType.Type );
			IntervalNodeAnimation i = dn.As<IntervalNodeAnimation>();
			return i;
		}
		#endregion
